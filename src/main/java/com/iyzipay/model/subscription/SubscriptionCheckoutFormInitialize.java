...
import com.iyzipay.request.InitSubscriptionCheckoutFormRequest;
...
public class SubscriptionCheckoutFormInitialize extends IyzipayResource {
    ...
    public static SubscriptionCheckoutFormInitialize create(InitSubscriptionCheckoutFormRequest request, Options options) {
        String uri = options.getBaseUrl() + "/api/v2/subscription/checkoutform/initialize";
